      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <?php
          ...
          $servicios = serviciosController::ctrMostrarServicios($item, $valor);
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" name="precioServicio" placeholder="Ingresar Precio" required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarNombreServicio" id="editarNombreServicio" required>
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" name="editarPrecioServicio" id="editarPrecioServicio" required>
