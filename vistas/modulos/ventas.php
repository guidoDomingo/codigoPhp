          ...
          foreach ($respuesta as $key => $value) {
           ...
           $productos = json_decode($value["productos"],true);
             ...
             foreach ($productos as $key1 => $value1) {
               # code...
                $suma+= $value1["cantidad"] * (empty($value1["precioNeto"]) ? 0 : $value1["precioNeto"]) ;
             }
           ...
           echo '<tr>
            ...
            echo '<tr>
                      ...
                      <td></td>
                      <td></td>
                      <td><strong>Total Precio Neto: </strong></td>
                      <td>'.number_format($sumaNeto,2).'</td>
                  </tr>';
            echo '<tr>
                      <td></td>
                      <td></td>
            ...
            echo '<tr>
                      ...
                      <td></td>
                      <td></td>
                      <td><strong>Total ganancia por producto: </strong></td>
